...
require(['/bxg/assets/js/config.js'],function(){
    require(['jquery','template','webuploader','validate','/bxg/assets/js/common.js','datepicker','form'],function($,template,webuploader){
        var pcd = {
            "p": {
                "000000": {
                    "110000": "北京市",
    ...
    //    封装后的代码
        ...
        function PCD2 () {
            ...
            var $city = $('[name="tc_city"]')
            var $district = $('[name="tc_district"]')
            getOptions('000000', $province, 'p')
            getOptions('110000', $city, 'c')
            getOptions('110100', $district, 'd')
            // province('000000', $province, 'p')
            function getOptions (code, $select, type) {
                var selectObj = pcd[type][code]
                var str = ''
                for( var key in selectObj) {
                    str += `<option value="${key}">${selectObj[key]}</option>`
                }
                $select.html(str)
                $select.trigger();
            }
            $city.on('change', function () {
                getOptions($(this).val(), $district, 'd')
            })
            $province.on('change', function () {
                getOptions($(this).val(), $city, 'c')
            })
